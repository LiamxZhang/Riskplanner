...
class SnapTrajectory:
    ...
    def traj(self, waypoints):
        ...
        # print("Total variables: ", self.variables)
    ...
    def output_next_traj_point(self, i = 20):
        ...
        """
        # self.variables = coeff of ["x^0, x^1, x^2, ..., x^n, 
        # y^0, y^1, y^2, ... y^n, 
        # z^0, z^1, z^2, ... z^n, 
        ...
        # # # loop = 2 : ax, ay, az, ayaw
        # acc_all = []
        # for j in range(4): # ax, ay, az, ayaw
        #     sigma = self.variables[j]
        #     t_poly = []
        #     for d in range(2,self.degree + 1): # polynomials' terms with different degrees
        #         t_poly.append(d*(d-1)*T ** (d-2))
        #     acc_all.append(np.dot(sigma[2:], t_poly))
        # print("acc_all: ", acc_all)
        
        # # # loop = 3 : jx, jy, jz, jyaw
        # jerk_all = []
        # for j in range(4): 
        #     sigma = self.variables[j]
        #     t_poly = []
        #     for d in range(3,self.degree + 1): 
        #         t_poly.append(d*(d-1)*(d-2)*T ** (d-3))
        #     jerk_all.append(np.dot(sigma[3:], t_poly))
        # print("jerk_all: ", jerk_all)
