...
def make_vec_env(
    ...
    vec_env_cls: Optional[Type[Union[DummyVecEnv, SubprocVecEnv, IsaacSubprocVecEnv, IsaacDummyVecEnv]]] = None,
    ...
    def make_env(rank: int) -> Callable[[], gym.Env]:
        def _init() -> gym.Env:
            ...
            from PerceptDroneNav import PerceptDroneNav, PerceptDroneNavSplitStep
            env = PerceptDroneNavSplitStep()
            # env = PerceptDroneNavSplitStep()
            # ================================
            if seed is not None:
